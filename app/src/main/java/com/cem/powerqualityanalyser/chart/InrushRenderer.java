...
public class InrushRenderer extends VoltsAmpsHertzYAxisRenderer{

    protected VoltsAmpsHertzYAxis mYAxis;
    public InrushRenderer(ViewPortHandler viewPortHandler, VoltsAmpsHertzYAxis yAxis, Transformer trans) {
